...
namespace CustomSRP.Runtime
{
    public class GBuffers
    {
        ...
        public void Render()
        {
            ...
            RAPI.Buffer.GetTemporaryRT(positionViewSpaceAtlas, (int)cameraWidthHeight.x, (int)cameraWidthHeight.y, 32, FilterMode.Bilinear, RenderTextureFormat.ARGBFloat);
